...
public class HttpAgreement {
    ...
    public static final String  FRIEND_LIST_ADD_REQUEST="##*$@@#friend_list_add";       //增加好友列表请求
    public static final String  FRIEND_LIST_delete_REQUEST="##*$@@#friend_list_delete"; //删除好友列表请求
    ...
    public static final String  SEARCH_USER_NAME_REQUEST="##*$@@#search_user_name";     //获取用户名请求
}
